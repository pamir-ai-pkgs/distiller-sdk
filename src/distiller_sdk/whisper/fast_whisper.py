...
class Whisper:
    ...
    def __init__(
        self, model_config=None, audio_config=None, configure_audio: bool = True
    ) -> None:
    ...
    @staticmethod
    def get_status(model_path: Optional[str] = None, model_size: str = "faster-distil-whisper-small.en") -> HardwareStatus:
    ...
    @staticmethod
    def is_available(model_path: Optional[str] = None, model_size: str = "faster-distil-whisper-small.en") -> bool:
