...
class Piper:
    ...
    @staticmethod
    def get_status(model_path: Optional[str] = None, piper_path: Optional[str] = None) -> HardwareStatus:
    ...
    def get_wav_file_path(self, text: str, output_path: Optional[str] = None) -> str:
        ...
        command = [
            self.piper,
            "--model", self.voice_onnx,
            "--config", self.voice_json,
    ...
    def speak_stream(self, text: str, volume: int = 50, sound_card_name: Optional[str] = None) -> None:
