...
class TestAudioDetection:
    ...
    def test_get_status_returns_hardware_status(self, mock_audio_hardware: None) -> None:
    ...
    def test_get_status_available_hardware(self, mock_audio_hardware: None) -> None:
    ...
    def test_get_status_unavailable_hardware(self, mock_audio_unavailable: None) -> None:
    ...
    def test_get_status_partial_input_only(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_get_status_partial_output_only(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_get_status_includes_volume_control_capability(
        self, mock_audio_hardware: None, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_get_status_no_volume_control(
        self, mock_audio_hardware: None, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_get_status_includes_diagnostic_info(self, mock_audio_hardware: None) -> None:
    ...
    def test_is_available_returns_bool(self, mock_audio_hardware: None) -> None:
        """Test that is_available returns a boolean."""
        result = Audio.is_available()

        assert isinstance(result, bool)

    def test_is_available_true_when_hardware_present(self, mock_audio_hardware: None) -> None:
        """Test is_available returns True when hardware is present."""
        assert Audio.is_available() is True

    def test_is_available_false_when_hardware_absent(self, mock_audio_unavailable: None) -> None:
        """Test is_available returns False when hardware is absent."""
        assert Audio.is_available() is False

    def test_is_available_consistent_with_get_status(self, mock_audio_hardware: None) -> None:
    ...
    def test_get_status_does_not_initialize_hardware(self, mock_audio_hardware: None) -> None:
    ...
    def test_is_available_does_not_initialize_hardware(self, mock_audio_hardware: None) -> None:
    ...
    def test_get_status_no_exceptions_on_failure(self, mock_audio_unavailable: None) -> None:
    ...
    def test_is_available_no_exceptions_on_failure(self, mock_audio_unavailable: None) -> None:
    ...
    def test_get_status_caches_device_list(self, mock_audio_hardware: None) -> None:
    ...
    def test_get_status_handles_various_errors(
        self, monkeypatch: pytest.MonkeyPatch, command_error: Any
    ) -> None:
