...
class TestDisplayDetection:
    ...
    def test_get_status_includes_diagnostic_info(self, mock_display_hardware):
        ...
        has_info = any(key in status.diagnostic_info for key in ['library_path', 'spi_device', 'gpio_chip', 'config'])
        assert has_info
    ...
    def test_get_status_detects_firmware_type(self, mock_display_hardware, monkeypatch, firmware_type):
