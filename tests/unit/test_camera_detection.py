...
class TestCameraDetection:
    ...
    def test_get_status_returns_hardware_status(self, mock_camera_hardware):
    ...
    def test_get_status_available_hardware(self, mock_camera_hardware):
    ...
    def test_get_status_unavailable_no_rpicam(self, monkeypatch):
    ...
    def test_get_status_no_camera_detected(self, monkeypatch):
        ...
        assert "camera" in status.message.lower() and ("not" in status.message.lower() or "no" in status.message.lower())

    def test_get_status_includes_capabilities(self, mock_camera_hardware):
    ...
    def test_get_status_includes_diagnostic_info(self, mock_camera_hardware):
    ...
    def test_is_available_returns_bool(self, mock_camera_hardware):
        """Test that is_available returns a boolean."""
        result = Camera.is_available()

        assert isinstance(result, bool)

    def test_is_available_true_when_hardware_present(self, mock_camera_hardware):
    ...
    def test_is_available_consistent_with_get_status(self, mock_camera_hardware):
    ...
    def test_get_status_does_not_initialize_hardware(self, mock_camera_hardware):
    ...
    def test_is_available_does_not_initialize_hardware(self, mock_camera_hardware):
    ...
    def test_get_status_handles_various_errors(self, monkeypatch, error_type):
        ...
        assert isinstance(
            status.error,
            (FileNotFoundError, PermissionError, subprocess.CalledProcessError)
        )
    ...
    def test_get_status_detects_multiple_cameras(self, monkeypatch):
